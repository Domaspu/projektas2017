            ...
            <div class="line">
               ...
               <div class="margin">
                  ...
                  <div class="s-12 m-12 l-5">
                    ...
                    <form class="customform" method="post" action="comments.php">
                      <div class="s-12"><input name="userEmail" placeholder="Jūsų el. paštas" title="Your e-mail" type="text" /></div>
                      <div class="s-12"><input name="username" placeholder="Jūsų vardas" title="Your name" type="text" /></div>
                      <div class="s-12"><textarea placeholder="Jūsų žinutė" name="text" rows="5"></textarea></div>
                      <div class="s-12 m-12 l-4"><button class="color-btn" name="submit" type="submit">Siųsti</button></div>
                    </form>
                  </div>
               </div>
            </div>
