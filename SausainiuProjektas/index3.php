...
<html lang="en-US">
   <head>
	...
	<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
	  ...
	  <script type="txt/javascript" src="js/images.js"></script>
   ...
   <body class="size-1140">
      ...
      <section>
         ...
         <div id="first-block">
            <div class="line">
               <h1>Sausainis</h1>
               <p>Mažas konditerijos gaminys iškeptas iš miltų. Formuojami apskritimo, kvadrato, rombo, juostelių, žvaigždučių ir kitokiomis formomis. Į tešlą dėl skonio kartais dedami džiovinti vaisiai, riešutai, grūdai. Sausainiai gali būti kepami su šokoladiniu, kreminiu, aguoniniu ir kitais įdarais jų viduje arba tarp sausainių.</p>
               ...
               <div class="margin">
                  ...
                  <div class="s-12 m-12 l-5">
                    ...
                    <form class="customform" action="">
                      ...
                      <div class="s-12 m-12 l-4"><button class="color-btn" onclick="window.location.href='/index3.php#contact'">Siųsti</button></div>
